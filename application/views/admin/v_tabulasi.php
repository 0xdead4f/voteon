...
<body>
	<div class="container">
		<div class="hero-unit">
			...
			<div class="row">
				<div class="span6">
					<h1>Perhitungan Suara Kepala Desa</h1>
				</div>
				<div class="span3">
			...
			<div class="row">
				<div class="span6">
					<button id="mulai" class="btn btn-large" autofocus>Hitung suara</button>
				</div>
				<div class="span4">
					<div class="row-fluid">
						<table>
							<td>
								<div class="span3" align="center">Suara terhitung<h1><span id="nomer">0</span></h1>
								</div>
							</td>
							<td>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;</td>
							<td>
								<div class="span3" align="center">Suara tersisa<h1><span id="nomersisa">0</span></h1>
								</div>
							</td>
							<td>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;</td>
							<td>
								<div class="span3" align="center">Persentase Suara terhitung<h1><span id="persentase">0</span>%</h1>
								</div>
							</td>
						</table>
					</div>
			...
			<div class="row">
				...
				<div class="span4">
					<table border="0">
						<tr>
							<div class="span3" style="font-size:50px;padding-top:40px;color:#0e90d2;">ID . <span id="id" style="margin-left: 90px;font-size:100px;">-</span></div>
						</tr>
						<td>
							<div class="span3" align="right" style="font-size:50px; padding-top:50px;">Suara<h1><span id="vote" style="color:#0e90d2;font-size:200px;"> - </span></h1>
							</div>
						</td>
					</table>
				</div>
			...
			<script>
				...
				function getSuara(id) {
					$.post("<?php echo base_url(); ?>admin/a", {
						operation: 4,
						limit: id
					}, function(q) {
						$("#id").html(q);
				...
				function getSuara2(id) {
					$.post("<?php echo base_url(); ?>admin/b", {
						operation: 4,
						limit: id
					}, function(q) {
						$("#spoil").html('<h1>' + q + '</h1>');
