        ...
        <div class="container">
            ...
            <div id="back">
                ...
                <div id="form" style="background: rgba(0, 0, 0, 0.5);box-sizing: border-box;box-shadow: 0 15px 25px rgb(0 0 0 / 60%);">
                    ...
                    <?php echo form_open('admin/insert_pemilih'); ?>
                    ...
                    <div id="error_validation" style="color:white;"><?php echo validation_errors(); ?></div>
                    ...
                    <select name="status" id="status" style="width: 100%;padding: 15px;background: rgba(0, 0, 0, 0.5);border: none;margin-bottom:5px;">
